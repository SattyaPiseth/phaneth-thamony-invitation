  ...
  return (
    <>
      ...
      >
        <h3
          id="gratitude-title"
          className="moul-regular text-[var(--primary)] text-xs sm:text-lg lg:text-sm tracking-wide text-center text-balance"
        >
          សេចក្ដីថ្លែងអំណរគុណ និងសូមអភ័យទោស
        </h3>

        <p className="moulpali-regular mt-4 text-[0.65rem] sm:text-xs md:text-sm lg:text-sm xl:text-base tracking-wide leading-[3.5vh] text-[var(--text)]/90 text-pretty">
